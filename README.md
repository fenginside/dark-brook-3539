...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cp
```

A live public deployment of this template is available at [https://cp.templates.workers.dev](https://cp.templates.workers.dev)
